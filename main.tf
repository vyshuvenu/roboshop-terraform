module "vpc" {
  source = "git::https://github.com/vyshuvenu/tf-module-vpc.git"
...
module "alb" {
  source = "git::https://github.com/vyshuvenu/tf-module-alb.git"
...
#
#module "rds" {
#  source = "git::https://github.com/vyshuvenu/tf-module-rds.git"
#  tags   = var.tags
#  env    = var.env
#
#  for_each = var.rds
